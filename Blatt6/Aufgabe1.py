...
plt.figure(7)
plt.plot (k1,abwrg, 'b+', label='Gradientenverfahren')
plt.grid()
plt.xlabel('k')
plt.ylabel('Abw')
plt.legend(loc="best")
...
plt.figure(9)
plt.plot (k2,abwrc, 'rx', label='Konjugiertes Gradientenverfahren')
plt.grid()
plt.xlabel('k')
plt.ylabel('Abw')
plt.legend(loc="best")
...
plt.figure(10)
plt.plot (k3,abwb1g, 'b+', label='Gradientenverfahren')
plt.grid()
plt.xlabel('k')
plt.ylabel('Abw')
plt.legend(loc="best")
...
plt.figure(11)
plt.plot (k4,abwb1c, 'rx', label='Konjugiertes Gradientenverfahren')
plt.grid()
plt.xlabel('k')
plt.ylabel('Abw')
plt.legend(loc="best")
...
plt.figure(12)
plt.plot (k5,abwb2g, 'b+', label='Gradientenverfahren')
plt.grid()
plt.xlabel('k')
plt.ylabel('Abw')
plt.legend(loc="best")
...
plt.figure(13)
plt.plot (k6,abwb2c, 'rx', label='Konjugiertes Gradientenverfahren')
plt.grid()
plt.xlabel('k')
plt.ylabel('Abw')
plt.legend(loc="best")
