...
anim1.save('Animations/Animation_1.mp4', fps=fps1, extra_args=['-vcodec', 'libx264'])

Y3 = np.genfromtxt('./Data/2_3.txt')
...
anim3.save('Animations/Animation_3.mp4', fps=fps3, extra_args=['-vcodec', 'libx264'])
