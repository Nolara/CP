\section*{Aufgabe 1: Runge-Kutta-Verfahren}
  ...
  \subsection*{a)}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=10cm]{../../Blatt7/Plots/plot_A1_2}
      \caption{Lösung der Newtonsche Bewegungsgleichung für die AB \ref{eqn:AB2} und $h=1/100$.}
      \label{fig:A12}
    \end{figure}
    \begin{figure}
      \centering
      \includegraphics[width=10cm]{../../Blatt7/Plots/plot_A1_3}
  ...
  \subsection*{b)}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=10cm]{../../Blatt7/Plots/plot_A1_abw}
  ...
  \subsection*{c)}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=10cm]{../../Blatt7/Plots/plot_A1_E}
      \caption{Gesammtenergie für AB \ref{eqn:AB1} und verschiedene Schrittweiten.}
      \label{fig:A1E}
    \end{figure}
    \begin{figure}
      \centering
      \includegraphics[width=10cm]{../../Blatt7/Plots/plot_A1_E2}
