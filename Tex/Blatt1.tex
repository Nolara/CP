...
Die Datenpunkte sind zusammen mnit der errechnet Ausgleichsgerade in Abbildung \ref{fig:gerade} dargestellt.
\begin{figure}[H]
  \centering
  \includegraphics[height=8cm]{../plots/2.pdf}
  \caption{Datenpunkte sowie die errechnete Ausgleichsgerade.}
  \label{fig:gerade}
\end{figure}
