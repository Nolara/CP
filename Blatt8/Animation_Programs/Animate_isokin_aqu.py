...
x1,y1= np.genfromtxt('./Data/Werte_aqu_isokin.txt', unpack=True)
...
anim = FuncAnimation(fig, animate, frames=np.arange(1,l,1 ), save_count=100)

anim.save('Animations/Animation_aqu_isokin.mp4', writer=writer)
