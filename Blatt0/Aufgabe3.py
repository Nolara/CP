...
en_rel_a=abs(an_a-en_a)/an_a*100 #berechne relativen Fehler
es_rel_a=abs(an_a-es_a)/an_a*100#berechne relativen Fehler
en_rel_b=abs(an_b-en_b)/an_b*100 #berechne relativen Fehler
es_rel_b=abs(an_b-es_b)/an_b*100#berechne relativen Fehler
...
#Plot relative Fehler aus beiden Aufgabenteilen
plt.figure(5)
